import { unref, withCtx, createVNode, withModifiers, openBlock, createBlock, Fragment, renderList, toDisplayString, withDirectives, vModelText, createTextVNode, useSSRContext } from "vue";
      ...
      _push(ssrRenderComponent(AuthenticatedLayout, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<!--]--></div></div><div class="card mb-4"${_scopeId}><div class="card-header"${_scopeId}><h5 class="mb-0"${_scopeId}>Email Notifications</h5></div><div class="card-body"${_scopeId}><p class="text-muted small mb-3"${_scopeId}> Contact form inquiries and job applications are sent to these email addresses. Separate multiple addresses with a comma, e.g. <code${_scopeId}>vitanov1@yahoo.com, info@babormedical.com</code></p><!--[-->`);
            ssrRenderList(unref(notificationSettings), (setting) => {
              _push2(`<div class="mb-3"${_scopeId}><label class="form-label fw-bold"${_scopeId}>${ssrInterpolate(setting.label)}</label><input${ssrRenderAttr("value", unref(form)[`${setting.key}_en`])} type="text" class="form-control" placeholder="email@example.com, another@example.com"${_scopeId}></div>`);
            });
              ...
              createVNode("div", { class: "py-4" }, [
                createVNode("div", { class: "container" }, [
                  createVNode("form", {
                    ...
                    createVNode("div", { class: "card mb-4" }, [
                      createVNode("div", { class: "card-header" }, [
                        createVNode("h5", { class: "mb-0" }, "Email Notifications")
                      ]),
                      createVNode("div", { class: "card-body" }, [
                        createVNode("p", { class: "text-muted small mb-3" }, [
                          createTextVNode(" Contact form inquiries and job applications are sent to these email addresses. Separate multiple addresses with a comma, e.g. "),
                          createVNode("code", null, "vitanov1@yahoo.com, info@babormedical.com")
                        ]),
                        (openBlock(true), createBlock(Fragment, null, renderList(unref(notificationSettings), (setting) => {
                          return openBlock(), createBlock("div", {
                            key: setting.key,
                            class: "mb-3"
                          }, [
