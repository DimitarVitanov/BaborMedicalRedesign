...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Edit Location" }, null, _parent));
      _push(ssrRenderComponent(AuthenticatedLayout, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex justify-content-between align-items-center"${_scopeId}><h2 class="h4 mb-0"${_scopeId}>Edit Location</h2>`);
            ...
            return [
              createVNode("div", { class: "d-flex justify-content-between align-items-center" }, [
                createVNode("h2", { class: "h4 mb-0" }, "Edit Location"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`</div><div class="col-md-6 mb-3"${_scopeId}><label class="form-label"${_scopeId}>Location Name (Macedonian) *</label><input${ssrRenderAttr("value", unref(form).name_mk)} type="text" class="${ssrRenderClass([{ "is-invalid": unref(form).errors.name_mk }, "form-control"])}" required${_scopeId}>`);
            if (unref(form).errors.name_mk) {
              _push2(`<div class="invalid-feedback"${_scopeId}>${ssrInterpolate(unref(form).errors.name_mk)}</div>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(`</div></div><div class="row"${_scopeId}><div class="col-md-6 mb-3"${_scopeId}><label class="form-label"${_scopeId}>Address (English) *</label><input${ssrRenderAttr("value", unref(form).address_en)} type="text" class="${ssrRenderClass([{ "is-invalid": unref(form).errors.address_en }, "form-control"])}" required${_scopeId}>`);
            ...
            _push2(`</div><div class="col-md-6 mb-3"${_scopeId}><label class="form-label"${_scopeId}>Address (Macedonian) *</label><input${ssrRenderAttr("value", unref(form).address_mk)} type="text" class="${ssrRenderClass([{ "is-invalid": unref(form).errors.address_mk }, "form-control"])}" required${_scopeId}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/Locations/Edit.vue");
