...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[-->`);
      _push(ssrRenderComponent(unref(Head), { title: "Create Hero Slide - Admin" }, null, _parent));
      _push(ssrRenderComponent(AuthenticatedLayout, null, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="d-flex justify-content-between align-items-center"${_scopeId}><h2 class="h4 mb-0"${_scopeId}>Create Hero Slide</h2>`);
            ...
            return [
              createVNode("div", { class: "d-flex justify-content-between align-items-center" }, [
                createVNode("h2", { class: "h4 mb-0" }, "Create Hero Slide"),
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<small class="text-muted"${_scopeId}>Optimized for desktop (1920px+)</small></div><div class="col-md-4 mb-3"${_scopeId}><label class="form-label"${_scopeId}>Mobile WebP</label><input type="file" class="${ssrRenderClass([{ "is-invalid": unref(form).errors.image_mobile_webp }, "form-control form-control-sm"])}" accept="image/webp"${_scopeId}>`);
                    ...
                    createVNode("div", { class: "card-body" }, [
                      createVNode("form", {
                        ...
                        createVNode("div", { class: "d-flex gap-2 mt-4" }, [
                          ...
                          }, toDisplayString(unref(form).processing ? "Creating..." : "Create Slide"), 9, ["disabled"]),
                          createVNode(unref(Link), {
                            href: _ctx.route("admin.hero-slides.index"),
                            class: "btn btn-outline-secondary"
                          }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Admin/HeroSlides/Create.vue");
